...
const Project = () => {
  return (
    <div id='project' className='w-full px-[12%] py-25 scroll-mt-20'>
        <h4 className='text-center mb-2 text-lg'>My portfolio</h4>
        <h2 className='text-center text-5xl '>My Projects</h2>

        <p className='text-center max-w-2xl mx-auto mt-5 mb-12'>These are ,y projects based on my skills.</p>
        ...
        <a className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] rounded-full px-10 py-3 mx-auto lightHover duration-200 ' href="">
