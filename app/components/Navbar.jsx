...
const Navbar = () => {
  ...
  const handleScroll = (e, id) => {
    e.preventDefault();
    closeMenu(); // Ensure mobile menu closes on click
    const element = document.getElementById(id);
    if (element) {
      // Snappy and immediate scrolling without perceived delay
      animate(window.scrollY, element.offsetTop - 80, {
        duration: 0.1,
        ease: "circOut",
  ...
  return (
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 transition-all duration-300 ${isScroll ? "bg-white/80 backdrop-blur-lg shadow-sm" : ""}`}
      >
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-300"
        >
          ...
          <li>
            <a onClick={(e) => handleScroll(e, "home")} href="#home">
              Home
            </a>
          </li>
          <li>
          ...
          <li>
            <a onClick={(e) => handleScroll(e, "skills")} href="#skills">
              Skills
            </a>
          </li>
          <li>
            <a onClick={(e) => handleScroll(e, "project")} href="#project">
              My Projects
            </a>
          </li>
          <li>
